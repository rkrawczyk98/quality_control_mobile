...
class ComponentSubcomponentProvider with ChangeNotifier {
  final ComponentSubcomponentController _controller;

  ComponentSubcomponentProvider(AuthProvider authProvider)
      : _controller = ComponentSubcomponentController(authProvider) {
    fetchSubcomponents();
  }

  List<ComponentSubcomponent> _subcomponents = [];

  List<ComponentSubcomponent> get componentsubcomponents => _subcomponents;
