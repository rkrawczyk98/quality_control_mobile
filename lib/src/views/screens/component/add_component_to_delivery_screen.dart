...
class AddComponentToDeliveryScreen extends StatefulWidget {
  final int deliveryId;

  const AddComponentToDeliveryScreen({super.key, required this.deliveryId});

  @override
  AddComponentToDeliveryScreenState createState() =>
      AddComponentToDeliveryScreenState();
}

class AddComponentToDeliveryScreenState
    extends State<AddComponentToDeliveryScreen> {
